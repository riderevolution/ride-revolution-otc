    ...
    methods: {
      toggleClose(status) {
        ...
        if (status) {
          ...
          me.loader(true)
          me.$axios
            .delete(`api/schedules/${me.scheduled_date_id}`, {
              headers: {
              ...
              if (res.data) {
                setTimeout(() => {
                  ...
                  me.$parent.actionMessage =
                    'Schedule has been successfully cancelled'
                ...
                if (me.$parent.studio.online_class) {
                  ...
                  setTimeout(() => {
                    if (me.$parent.$refs.plan) {
                      ...
                      me.$parent.$refs.plan.fetchSeats(
                        null,
                        me.$parent.studioID
                      )
                      document.querySelector(
                        '.plan_wrapper'
                      ).style.transform = `matrix(0.4, 0, 0, 0.4, ${me.$parent.customWidth}, ${me.$parent.customHeight})`
                    }
                  }, 10)
                }
                me.loader(false)
