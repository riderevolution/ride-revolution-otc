        ...
        methods: {
            toggleClose (status) {
                ...
                if (status) {
                    ...
                    me.loader(true)
                    me.$axios.delete(`api/bookings/${me.$store.state.bookingID}`, {
                        headers: {
                        ...
                        if (res.data) {
                            setTimeout( () => {
                                if (res.data.hasGuests == 1) {
                                    me.$parent.actionMessage = 'Booking has been successfully cancelled, including the guest(s).'
                                } else {
                                    me.$parent.actionMessage = 'Booking has been successfully cancelled.'
                                }
