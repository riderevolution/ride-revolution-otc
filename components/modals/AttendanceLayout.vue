<template>
    <transition name="fade">
        <div class="upcoming_classes_layout table" v-if="loaded">
            ...
            <div class="action_back_btn" @click="toggleClose()">
            ...
            <div class="table_layout">
                ...
                <div class="actions">
                    ...
                    <div class="cms_table_toggler">
                        ...
                        <div
                            :class="`status ${
                                classesHistoryStatus == 'completed'
                                    ? 'active'
                                    : ''
                            }`"
                            @click="initial('completed')"
                        >
                            Completed
                        </div>
                        <div
                            :class="`status ${
                                classesHistoryStatus == 'no-show'
                                    ? 'active'
                                    : ''
                            }`"
                            @click="initial('no-show')"
                        >
                            No Show
                        </div>
                        <div
                            :class="`status ${
                                classesHistoryStatus == 'cancelled'
                                    ? 'active'
                                    : ''
                            }`"
                ...
                <div class="cms_table_scroll">
                    <table class="cms_table">
                        ...
                        <tbody v-if="res.classHistory.length > 0">
                            <tr
                                v-for="(data, key) in res.classHistory"
                                :key="key"
                            >
                                <td>
                                    {{ formatClassDate(data.created_at, true) }}
                                </td>
                                ...
                                <td>
                                    {{
                                        data.scheduled_date.schedule.studio.name
                                    }}
                                </td>
                                <td>
                                    <div class="thumb">
                                        ...
                                        <nuxt-link
                                            ...
                                            :to="`/instructors/${data.instructor.id}/class-schedules`"
                                        >
                                            {{
    ...
    export default {
        ...
        methods: {
            ...
            initial(status) {
                ...
                me.$axios
                    .get(
                        `api/customers/${me.customer.id}/class-history?classHistoryStatus=${status}`
                    )
                    .then(res => {
                        if (res.data) {
                            setTimeout(() => {
