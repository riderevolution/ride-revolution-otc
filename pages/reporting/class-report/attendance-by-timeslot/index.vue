    ...
    export default {
            ...
            attendanceByTimeslotAttributes () {
                ...
                return [
                    ...me.values.map((value, key) => ({
                        ...
                        'Full Name': (value.user) ? value.user.fullname : `${value.guest_first_name} ${value.guest_last_name}`,
        ...
        methods: {
            ...
            getClasses () {
                ...
                me.values = []
                me.loader(true)
                me.$axios.post(`api/exports/class-report/attendance-by-timeslot`, formData).then(res => {
                    if (res.data) {
