                    ...
                    <div class="action_wrapper">
                        ...
                        <div class="actions">
                            ...
                            <download-csv
                                ...
                                :name="`sales-by-subscription-${$moment(form.start_date).format('MM-DD-YY')}-${$moment(form.end_date).format('MM-DD-YY')}.csv`">
                                Export
                            </download-csv>
        ...
        methods: {
            ...
            toggleStatus (value) {
                ...
                setTimeout( () => {
                    let formData = new FormData(document.getElementById('filter'))
                    me.loader(true)
                    me.$axios.post('api/reporting/sales/sales-by-subscription', formData).then(res => {
                        if (res.data) {
                            setTimeout( () => {
                                me.res = res.data
