                            ...
                            <div class="form_flex">
                                <div class="form_flex_radio">
                                    ...
                                    <div class="form_radio">
                                        <input type="radio" id="female" value="F" name="io_sex" class="action_radio">
                                        <label for="female">Female</label>
                                    </div>
                                    <div class="form_radio">
                                        <input type="radio" id="male" value="M" name="io_sex" class="action_radio">
                                        <label for="male">Male</label>
                                    </div>
                                    <transition name="slide"><span class="validation_errors" v-if="errors.has('io_sex')">{{ errors.first('io_sex') }}</span></transition>
                                </div>
                                <div class="form_group">
