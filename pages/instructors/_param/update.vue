                            ...
                            <div class="form_main_group">
                                ...
                                <div class="form_flex">
                                    <div class="form_flex_radio">
                                        ...
                                        <div class="form_radio">
                                            <input type="radio" id="female" value="F" name="io_sex" @change="getSizes()" v-validate="'required'" class="action_radio" v-model="form.gender">
                                            <label for="female">Female</label>
                                        </div>
                                        <div class="form_radio">
                                            <input type="radio" id="male" value="M" name="io_sex" @change="getSizes()" v-validate="'required'" class="action_radio" v-model="form.gender">
                                ...
                                <div class="form_flex">
                                    <div class="form_group">
                                        ...
                                        <select :class="`default_select alternate ${(form.gender.length > 0) ? '' : 'disabled'}`" name="io_shoe_size" v-model="res.instructor_details.io_shoe_size" v-validate="'required'">
            ...
            submissionSuccess () {
                ...
                me.$validator.validateAll().then(valid => {
                    if (valid) {
                        ...
                        me.loader(true)
                        me.$axios.post(`api/instructors/${me.$route.params.param}`, formData, {
                            headers: {
            ...
            if (me.access) {
                ...
                me.$axios.get(`api/instructors/${me.$route.params.param}`).then(res => {
                    setTimeout( () => {
                        ...
                        me.form.gender = res.data.user.instructor_details.io_sex
