                            ...
                            <div class="form_main_group">
                                ...
                                <div class="form_flex">
                                    ...
                                    <div class="form_group">
                                        ...
                                        <input type="text" name="phone" placeholder="Enter country" autocomplete="off" class="default_text" v-validate="'numeric|min:7|max:15'">
                            ...
                            <div class="form_main_group">
                                <div class="form_flex">
                                    <div class="form_group">
                                        ...
                                        <input type="text" name="total_attendance" placeholder="Enter total attendance" autocomplete="off" class="default_text" v-validate="'required|number|min:1|max:99999'">
                                    ...
                                    <div class="form_group">
                                        ...
                                        <input type="text" name="package_sales" placeholder="Eneter package sales" autocomplete="off" class="default_text" v-validate="'required|number|min:1|max:99999'">
                                ...
                                <div class="form_flex">
                                    <div class="form_group">
                                        ...
                                        <input type="text" name="first_time_riders" placeholder="Enter first time riders" autocomplete="off" class="default_text" v-validate="'required|number|min:1|max:99999'">
                                    ...
                                    <div class="form_group">
                                        ...
                                        <input type="text" name="returning_riders" placeholder="Enter returning riders" autocomplete="off" class="default_text" v-validate="'required|number|min:1|max:99999'">
