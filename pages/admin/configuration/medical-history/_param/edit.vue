            ...
            <div id="admin" class="cms_dashboard">
                <section id="top_content" class="table">
                    ...
                    <div class="action_wrapper">
                        <h1 class="header_title">Update {{ res.title }}</h1>
                    </div>
                </section>
                <section id="content">
                            ...
                            <div class="form_main_group">
                                <div class="form_flex">
                                    <div class="form_group">
                                        ...
                                        <input type="text" name="title" autocomplete="off" class="default_text" autofocus v-validate="'required|min:10|max:500'" v-model="res.title">
                                    ...
                                    <div class="form_group">
                                        ...
                                        <input type="text" name="sequence" autocomplete="off" class="default_text" v-validate="'required|numeric|min_value:0|max_value:99999'" v-model="res.sequence">
            ...
            submissionSuccess () {
                ...
                me.$validator.validateAll().then(valid => {
                    if (valid) {
                        ...
                        me.loader(true)
                        me.$axios.post(`api/extras/medical-history-questions/${me.res.id}`, formData, {
                            headers: {
