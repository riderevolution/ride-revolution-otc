                                ...
                                <div class="form_flex">
                                    <div class="form_group flex">
                                        ...
                                        <div class="form_flex_input">
                                            ...
                                            <input type="text" name="estimated_price_per_class" class="default_text disabled number" autocomplete="off" v-validate="{required: true, decimal: 2, min_value: 0, max_value: 999999}" v-model="form.estimated_price">
                                            <div class="placeholder">PHP</div>
