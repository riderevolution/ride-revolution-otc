                        ...
                        <div class="form_wrapper">
                            ...
                            <div class="form_main_group">
                                ...
                                <div class="form_group">
                                    ...
                                    <textarea name="description" rows="8" class="default_text" id="description" v-validate="'required|max:3000'"></textarea>
                            ...
                            <div class="form_main_group">
                                ...
                                <div class="form_flex">
                                    ...
                                    <div class="form_group flex">
                                        ...
                                        <div class="form_flex_input" v-if="isUnlimited">
                                            ...
                                            <input type="text" name="max_classes" placeholder="Enter max classes" class="default_text number" v-model="res.max_classes" value="1" autocomplete="off" v-validate="'required|numeric|min_value:0|max_value:5'">
                                ...
                                <div class="form_flex">
                                    <div class="form_group flex">
                                        ...
                                        <div class="form_flex_input">
                                            <div class="form_check">
                                                <input type="checkbox" id="class_count_unlimited" name="class_count_unlimited" class="action_check" :checked="res.class_count_unlimited == 1" @change="toggleUnlimited()">
