            ...
            <div id="admin" class="cms_dashboard">
                <section id="top_content" class="table">
                    ...
                    <div class="action_buttons">
                        <div @click="toggleForm(id, 0)" class="action_btn"><svg xmlns="http://www.w3.org/2000/svg" width="17.016" height="17.016" viewBox="0 0 17.016 17.016"><defs></defs><g transform="translate(-553 -381)"><circle class="add" cx="8.508" cy="8.508" r="8.508" transform="translate(553 381)"/><g transform="translate(558.955 386.955)"><line class="add_sign" y2="5.233" transform="translate(2.616 0)"/><line class="add_sign" x2="5.233" transform="translate(0 2.616)"/></g></g></svg>Add New Category</div>
                    </div>
                </section>
                            ...
                            <div class="taxonomy_body">
                                <div class="taxonomy_header">
                                    ...
                                    <div class="taxonomy_actions">
                                        ...
                                        <div class="action_btn margin" @click="toggleForm(data.id, 1)"><svg xmlns="http://www.w3.org/2000/svg" width="21.316" height="16.434" viewBox="0 0 21.316 16.434"> <g transform="translate(-1244 -346.75)"> <path class="edit" d="M1259.684,357.585v4.849H1244.75V347.5h14.934v1.785" transform="translate(0 0)" /> <g transform="translate(1255.311 348.26)"> <line class="edit_sign" x1="9.476" y2="9.476" /> </g> </g> </svg>Edit</div>
                                    </div>
                                </div>
                                            ...
                                            <tr v-for="(product, key) in data.products" :key="key">
                                                ...
                                                <td>
                                                    <div class="table_actions">
                                                        ...
                                                        <div class="table_action_cancel link" @click.self="toggleStatus(product.id, 0, 'Deactivated')" v-if="status == 1">Deactivate</div>
                                                        <div class="table_action_success link" @click.self="toggleStatus(product.id, 1, 'Activated')" v-if="status == 0">Activate</div>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
                                ...
                                <div class="taxonomy_footer">
                                    <div class="action_cancel_btn" @click="toggleDelete(data.id)">Delete Category</div>
                                </div>
                            </div>
                        </div>
                    </div>
