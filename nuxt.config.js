...
export default {
  ...
  */
  axios: {
    ...
    baseURL: (process.env.NODE_ENV == "development") ? 'http://ea200827.ngrok.io' : 'http://api-riderev.designbluemanila.ph',
    // baseURL: (process.env.NODE_ENV == "development") ? 'http://8fd66087.ngrok.io' : 'http://api-riderev.designbluemanila.ph',
